...
function main()
	local tInitPara = {--ltest_filter = "",
		ltest_list_tests = ".\\output\\ltest_case_list.txt",
		ltest_list_falied = ".\\output\\ltest_case_failed.txt",
		ltest_output = ".\\output\\ltest_case_output.json"
	}
